...
define('TITLE', 'Compliance');
define('ROUTER', 'compliance');
define('ENTITY', 'Risk\Entity\Compliance');
...
class ComplianceController extends AbstractActionController {
    /*
     *

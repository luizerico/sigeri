...
define('TITLE', 'Control Status');
define('ROUTER', 'controlstatus');
define('ENTITY', 'Risk\Entity\ControlStatus');
...
class ControlStatusController extends AbstractActionController {

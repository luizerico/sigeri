...
class MethodOwaspController extends GenericController {

    public function __construct() {
        $this->object = new MethodOwasp();
        $this->entity = 'Risk\Entity\MethodOwasp';
        $this->title = 'Method OWASP';
        $this->route = 'methodowasp';

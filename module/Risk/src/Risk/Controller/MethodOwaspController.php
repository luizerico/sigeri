...
define('TITLE', 'MethodOwasp');
define('ROUTER', 'methodowasp');
define('ENTITY', 'Risk\Entity\MethodOwasp');

use Risk\Entity\MethodOwasp;
...
class MethodOwaspController extends AbstractActionController {
    /*
     *

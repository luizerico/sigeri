...
define('TITLE', 'Compliance Rule');
define('ROUTER', 'compliancerule');
define('ENTITY', 'Risk\Entity\ComplianceRule');
...
class ComplianceRuleController extends AbstractActionController {
    /*
     *

...
define('TITLE', 'Risk Review');
define('ROUTER', 'riskreview');
define('ENTITY', 'Risk\Entity\RiskReview');
...
class RiskReviewController extends AbstractActionController {

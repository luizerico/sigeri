...
define('TITLE', 'Plan Strategy');
define('ROUTER', 'planstrategy');
define('ENTITY', 'Risk\Entity\PlanStrategy');
...
class PlanStrategyController extends AbstractActionController {

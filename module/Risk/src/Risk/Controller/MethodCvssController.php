...
class MethodCvssController extends GenericController {

    public function __construct() {
        $this->object = new MethodCvss();
        $this->entity = 'Risk\Entity\MethodCvss';
        $this->title = 'Method CVSS';
        $this->route = 'methodcvss';

...
define('TITLE', 'MethodCvss');
define('ROUTER', 'methodcvss');
define('ENTITY', 'Risk\Entity\MethodCvss');

use Risk\Entity\MethodCvss;
...
class MethodCvssController extends AbstractActionController {
    /*
     *

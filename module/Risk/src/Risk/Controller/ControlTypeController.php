...
define('TITLE', 'Control Type');
define('ROUTER', 'controltype');
define('ENTITY', 'Risk\Entity\ControlType');
...
class ControlTypeController extends AbstractActionController {
    /*
     *
    ...
    public function addAction() {
        $addObject = new ControlType (); // To do: How to automate this...

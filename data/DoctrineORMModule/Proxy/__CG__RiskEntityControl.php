 ...
 */
class Control extends \Risk\Entity\Control implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'name', 'status', 'type', 'analyst', 'date', 'description', 'annotations', 'revisions', 'documents', 'submit');
        }
